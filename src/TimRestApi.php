...
class TimRestAPI extends TimRestInterface
{
     ...
     * @return bool 是否成功
     */
    public function http_req_multi($http_type, $method, $url, $data)
    {
        $mh       = curl_multi_init();
        $ch_list  = array();
        $i        = -1;
     ...
     */
    public function json_format($data, $indent = null)
    {
        // 对数组中每个元素递归进行urlencode操作，保护中文字符
        array_walk_recursive($data, [$this, 'json_format_protect']);
     ...
     */
    public function json_format_protect(&$val)
    {
